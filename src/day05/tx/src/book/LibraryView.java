package day05.tx.src.book;


import day03.member.Gender;

import static book.RentStatus.RENT_SUCCESS;
import static book.RentStatus.RENT_SUCCESS_WITH_COUPON;
    ...
    private static void selectMenu() {
        ...
        switch (menuNum) {
            ...
            case "4":
                ...
                book.RentStatus rentStatus = repository.rentBook(Integer.parseInt(rentNum));
